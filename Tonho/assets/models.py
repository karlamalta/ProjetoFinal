...
class AlternativeScenarios(models.Model):
    ...
    def changeform_link(self):
        if self.id:
            ...
            return u'<a href="%s" target="_blank">Steps</a>' % changeform_url
        return u'Save to Edit Steps'
    changeform_link.allow_tags = True
    changeform_link.short_description = 'Scenario Steps'   # omit column header

class AlternativeSteps(models.Model):    
    use_case = models.ForeignKey(AlternativeScenarios)
    #step_number = models.CharField(max_length=2, verbose_name="Step")
